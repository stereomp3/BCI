...
def main():
    ...
    file_path = 'data/wei/05.csv'
    # file_path = 'data/j/05.csv'
    log_path = 'data/wei/05.txt'
    # log_path = 'data/j/05.txt'
    _segments, _labels = part1(file_path=file_path, log_path=log_path)
    segments.extend(_segments)
    labels.extend(_labels)
    ...
    # segments_f, labels_f = preprocess_segments_independently_with_windows(segments=segments, labels=labels, orig_fs=1000, new_fs=1000, window_sec=4.5, stride_sec=0.5, buffer_time=0.5)
    ...
    valid_num = 15  # 7/37 # best: 19 (0.684)
    # valid_num = int(len(segments_f) * 30 / 180)  # 7/37 # best: 19 (0.684)
