...
# 參數設定
BLINK_THRESHOLD = 150  # 振幅超過此值視為 blink，可根據實測調整
AMPLITUDE_QUEUE_SIZE = 50  # queue 長度
CHECK_INTERVAL = 0.2  # 每隔多久判斷一次 blink（秒）
...
def read_eeg(inlet):
    ...
    while True:
        ...
        if current_time - last_check_time >= CHECK_INTERVAL:
            ...
            #elif fp1_moderate > half and fp2_moderate > half and fp1_moderate < 400 and fp2_moderate < 400:
